...
def gpt_chat_completion(messages, model="gpt-3.5-turbo-0613", max_retry=5,
                        backoff_factor=2, initial_wait=.1, functions=None):
    """
    ...
    Args:
        ...
        functions (List[Dict], optional): A list of functions to be used in the chat.
...
def gpt4_completion(prompt, model="gpt-3.5-turbo"):
